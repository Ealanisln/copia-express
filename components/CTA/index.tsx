          ...
          <div className="flex flex-wrap gap-8 md:flex-nowrap md:items-center md:justify-between md:gap-0">
            ...
            >
              <h2 className="mb-4 w-11/12 text-3xl font-bold text-black dark:text-white xl:text-sectiontitle4">
               ¡Escríbenos o envíanos tu trabajo!
              </h2>
              <p>
                Tenemos a tu disposición nuestro Whatsapp, donde de forma completamente personalizada te ayudaremos a que tu tarea sea un éxito. 
              </p>
            </motion.div>
            <motion.div
              variants={{
