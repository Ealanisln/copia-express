  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        strokedark: "#2D2F40",
        hoverdark: "#252A42",
        titlebg: "#FFD9D6", // Suave tono rosado para armonizar con el rojo del logo
        titlebg2: "#FFE6D6", // Tono melocotón claro que combina con el naranja
        titlebgdark: "#46495A",
        btndark: "#292E45",
        white: "#FFFFFF",
        black: "#181C31",
        blackho: "#2C3149",
        blacksection: "#1C2136",
        primary: "#e42029", // Rojo principal del logo
        primaryho: "#ef5038", // Naranja del logo
        secondary: "#5b5a5d", // Gris del logo
        accent: "#FFD1C1", // Tono claro de melocotón
        meta: "#20C5A8",
        waterloo: "#757693",
        manatee: "#999AA1",
        alabaster: "#FBFBFB",
